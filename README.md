...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/blackcellmagic-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10435&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/blackcellmagic-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `blackcellmagic` can be installed with:

```
conda install blackcellmagic
```

It is possible to list all of the versions of `blackcellmagic` available on your platform with:
